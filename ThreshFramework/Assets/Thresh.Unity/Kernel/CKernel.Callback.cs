...
namespace Thresh.Unity.Kernel
{
    partial class CKernel
    {
        ...
        public void RegisterContainerCallback(string entity_type, string container_name, ContainerEvent event_enum, EventCallback handler)
        {
            _DataCallbackManager.AddContainerCallback(entity_type,container_name,event_enum,handler);
        }
